...
export const defaultHotspots: HotspotData[] = [
  ...
  { id: 'hp-prestige', pitch: -12, yaw: 83, title: 'Prestige Skytech', distance: 'Walk Away', icon: 'building' },
  { id: 'hp-ignite', pitch: -9, yaw: 64, title: 'Ignite Art Cafe', distance: 'Walk Away', icon: 'cafe' },
  { id: 'hp-tansen', pitch: -12, yaw: 93, title: 'Tansen Restaurant', distance: 'Walk Away', icon: 'restaurant' },
  ...
  { id: 'hp-south', pitch: -33, yaw: 174, title: 'Soul Of South Bar & Kitchen', distance: 'Walk Away', icon: 'bar' },
  { id: 'hp-track', pitch: -12, yaw: 203, title: 'Cycling Track', distance: '2 Mins', icon: 'cycling' },
  { id: 'hp-stories', pitch: -10, yaw: 108, title: 'Myscape Stories', distance: '2 Mins', icon: 'building' },
  { id: 'hp-kids', pitch: -8, yaw: 110, title: 'Kids District & Kids Lands', distance: '2 Mins', icon: 'kids' },
  { id: 'hp-orr', pitch: -12, yaw: 206, title: 'ORR', distance: '2 Mins', icon: 'road' },
  ...
  { id: 'hp-gaudium', pitch: -1, yaw: 405, title: 'The Gaudium School', distance: '5 Mins', icon: 'school' },
  ...
  { id: 'hp-capgemini', pitch: -7, yaw: 395, title: 'Capgemini', distance: '5 Mins', icon: 'tech' },
  { id: 'hp-amazon', pitch: -3, yaw: 35, title: 'Amazon Hyderabad Campus', distance: '5 Mins', icon: 'tech' },
  { id: 'hp-waverock', pitch: -1, yaw: 409, title: 'WaveRock SEZ', distance: '5 Mins', icon: 'tech' },
  { id: 'hp-shriram', pitch: -4, yaw: 313, title: 'Shriram Academy', distance: '10 Mins', icon: 'school' },
  ...
  { id: 'hp-google', pitch: -4, yaw: 460, title: 'Google', distance: '10 Mins', icon: 'tech' },
